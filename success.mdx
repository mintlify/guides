...
<Tip>
  In this article, you'll learn how to measure the success of your documentation with a balanced approach, blending quantitative metrics, qualitative feedback, and alignment with business goals.
</Tip>
...
- **User testing**: Conduct usability tests to validate whether users are able to find the answers they need and whether your documentation aligns with their expectations. See [Understand your audience](/know-your-audience) for more on user research.
- **AI assistant analytics**: Track what questions users ask your [AI assistant](https://www.mintlify.com/docs/ai/assistant) to understand common pain points, gaps in documentation, or areas where users struggle to find answers. This data reveals what users are actually looking for and helps prioritize documentation improvements.
